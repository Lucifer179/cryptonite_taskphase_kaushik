...
I understood that this is a substitution cipher due to the name so I put in the key provided which was "OHNFUMWSVZLXEGCPTAJDYIRKQB" in the substitution cipher tool along with the cipher text which is - 
```
